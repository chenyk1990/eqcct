...
DEMO2
The following figure shows an example of comparison between initial LOCSAT and refined NonLinLoc catalogs. Generated by [demos/test_eqcct_locsatvsnll.py](https://github.com/chenyk1990/eqcct/blob/main/demos/test_eqcct_locsatvsnll.py)
...
DEMO4
The following figure shows an example of comparison between one-month catalog before (up) and after (down) relocation, manual (left) and EQCCT (right). Generated by [demos/test_eqcct_relo_manualvsAI.py](https://github.com/chenyk1990/eqcct/blob/main/demos/test_eqcct_relo_manualvsAI.py)
...
DEMO5
The following figure shows an example of comparison between three-month (manual, left) and three-month (EQCCT, right) catalog after relocation. Generated by [demos/test_eqcct_relo_manualvsAI.py](https://github.com/chenyk1990/eqcct/blob/main/demos/test_eqcct_relo_manualvsAI.py)
